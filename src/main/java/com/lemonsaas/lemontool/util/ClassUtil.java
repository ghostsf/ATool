...
import com.lemonsaas.lemontool.convert.BasicType;
import com.lemonsaas.lemontool.exceptions.UtilException;
import com.lemonsaas.lemontool.io.FileUtil;
import com.lemonsaas.lemontool.io.IORuntimeException;
import com.lemonsaas.lemontool.io.resource.ResourceUtil;
import com.lemonsaas.lemontool.lang.ClassScaner;
import com.lemonsaas.lemontool.lang.Filter;
import com.lemonsaas.lemontool.lang.Singleton;
...
public class ClassUtil {
	 ...
	 * 
	 * <pre>
	 * isSimple为false: "com.lemonsaas.lemontool.util.ClassUtil"
	 ...
	 * 例如：com.lemonsaas.lemontool.StrUtil.isEmpty 或 com.lemonsaas.lemontool.StrUtil#isEmpty
	 ...
	 * 
	 * @param <T> 对象类型
	 * @param classNameWithMethodName 类名和方法名表达式，例如：com.lemonsaas.lemontool.StrUtil#isEmpty或com.lemonsaas.lemontool.StrUtil.isEmpty
	 ...
	 * 获得给定类所在包的名称<br>
	 * 例如：<br>
	 * com.lemonsaas.lemontool.util.ClassUtil =》 com.lemonsaas.lemontool.util
	 * 
	 * @param clazz 类
	 * @return 包名
	 */
	 ...
	 * 获得给定类所在包的路径<br>
	 * 例如：<br>
	 * com.lemonsaas.lemontool.util.ClassUtil =》 com/xiaoleilu/hutool/util
	 * 
	 * @param clazz 类
	 * @return 包名
	 */
