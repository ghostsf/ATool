...
import com.lemonsaas.lemontool.exceptions.ValidateException;
import com.lemonsaas.lemontool.util.NumberUtil;
...
public final class Validator {
	...
	public static boolean isLetter(String value) {
		return StrUtil.isAllCharMatch(value, new com.lemonsaas.lemontool.lang.Matcher<Character>() {
			@Override
