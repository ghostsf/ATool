...
import com.ghostsf.atool.util.NumberUtil;
import com.ghostsf.atool.util.ObjectUtil;
import com.ghostsf.atool.util.ReUtil;
import com.ghostsf.atool.util.StrUtil;
import com.ghostsf.atool.date.DateUtil;
import com.ghostsf.atool.exceptions.ValidateException;
...
public final class Validator {
	...
	public static boolean isLetter(String value) {
		return StrUtil.isAllCharMatch(value, new com.ghostsf.atool.lang.Matcher<Character>() {
			@Override
